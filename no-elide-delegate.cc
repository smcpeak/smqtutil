  ...
  QModelIndex const &index) const
{
  ...
  // TODO: One problem with this approach is the cropped text goes right
  // to the edge of the cell, where it can potentially merge with
  // cropped text from another cell.  I may need to do my own painting
  // after all...
